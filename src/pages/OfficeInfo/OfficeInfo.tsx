  ...
  return (
    <Box ref={ref}>
      ...
      validateOnMount
        ...
        onSubmit={({ ...values }) => {
          dispatch(actions.saveOfficeInfoData());
          submitOfficeInfo(values).then(x => {
            dispatch(actions.saveOfficeInfoDataSucceeded(values));
            setActionLabel("Next");
            onNext();
          }).catch(x => {
            dispatch(actions.saveOfficeInfoDataFailed());
