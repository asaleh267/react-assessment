...
export const saveConfirmationDataSucceeded = createAction<Confirmation>("save confirmation data success");
...
export const resetAttachments = createAction("reset Attachment");
